...
class Config(object):
    ...
    def __init__(self, genome_type, reproduction_type, species_set_type, stagnation_type, filename):
        ...
        # Parameters is an instance of a python ConfigParser
        ...
        # Parse type sections.
        # genome_dict is our object representing the genome read from our genome_type
        # which can be any given genome like DefaultGenome
        # genome_config is our parsed genome_type config file
